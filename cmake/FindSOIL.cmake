...
if(NOT TARGET SOIL)
	...
	set_target_properties(SOIL PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${SOIL_INCLUDE_DIRS}")
	set_target_properties(SOIL PROPERTIES IMPORTED_LOCATION "${SOIL_LIBRARIES}")
endif()
